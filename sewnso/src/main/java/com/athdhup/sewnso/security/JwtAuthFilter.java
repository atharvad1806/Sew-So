...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // No token present - let the request continue; Spring Security will
        // reject it later if the endpoint actually requires authentication
        ...
        try {
            ...
            // Downstream security rules will reject the request if auth was required.
        }
